...
result = nmodel_10(bootData);
results_ot.params(n,1:5) =  [n, 0, result.params]; 
results_ot.confirm(n,1:5) =  [n, 1, result.pseudoR2,result.loglike,result.bic]; 
display(n)
end
save([path,'nmodel_thesis_10_ot_',condition{con}],'results_ot');
end

clearvars -except condition path bootset nboot
...
clearvars -except condition path con bootset nboot
load([path,condition{con},'_data.mat']);
sum=[90,90,100,100,80,80,75,75,60,60,60,40,40,200,150,150,120,120,120,100]' ;
mul = [1,3;3,1;1,3;3,1;3,1;1,3;2,1;1,2;1,1;2,1;1,2;3,1;1,3;1,1;2,1;1,2;1,2;1,1;2,1;1,1];
...
result = nmodel_10(bootData);
results_pl.params(n,1:5) =  [n, 0, result.params]; 
results_pl.confirm(n,1:5) =  [n, 1, result.pseudoR2,result.loglike,result.bic]; 
display(n)
end
save([path,'nmodel_thesis_10_pl_',condition{con}],'results_pl');
